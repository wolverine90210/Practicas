...
function validaEnvio(){
		...
		document.getElementById("error_confirmpass").style.display="none";
		document.getElementById("error_eqpass").style.display="none";

		
		var expresion = new RegExp(/^[a-zA-Z0-9_ áÁ éÉ íÍ óÓ úÚ ñÑ][a-zA-z0-9_ áÁ éÉ íÍ óÓ úÚ ñÑ]{4,15}$/);
		
		if(!expresion.test(document.form1.username.value) || document.form1.username.value.length == 0){
			//alert("Introduzca un nombre de usuario v\u00e1lido! \nDebe comenzar con letra, n\u00famero o guion bajo; entre 5 y 15 caracteres.");
		...
		if(!expresion.test(document.form1.email.value) || document.form1.email.value.length == 0){
			//alert("Introduzca un email que sea válido!");
		...
		if(!expresion.test(document.form1.password.value) || document.form1.password.value.length == 0){
		...
		if(!expresion.test(document.form1.pconfirm.value) || document.form1.pconfirm.value.length == 0){
			//alert("Introduzca una contraseña válida!\nDebe tener entre 8 y 15 caracteres (números, letras y/o guion bajo).");
			document.getElementById("error_confirmpass").style.display='block';
			document.form1.pconfirm.focus();
			return 0;
		}
		...
		if(!(document.form1.password.value == document.form1.pconfirm.value)){		
			...
			document.getElementById("error_eqpass").style.display='block';
			return 0;
		}

		document.form1.pass.value = md5(utf8_encode(document.form1.password.value));
